    ...
    if uploaded_file is not None:
        ...
        if confidence >= confidence_threshold:
          if predicted_class_name == endangered_animals:
            ...
            st.write(f"This is an image of '{predicted_class_name}', [matching {confidence:.2f} (in scale of 0 to 1)] / Given image is either not of an animal or is not endangered animal")
        else:
